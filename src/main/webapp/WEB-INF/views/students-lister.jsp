...
<body  style="background-color:pink;">
	...
	<div class="container">
		...
		<h3 style="background-color:aqua;">Students Directory</h3>
		<hr>
		<c:url var="addUrl" value = "/student/add-begin" />

		<!-- Add a button -->
		<a href="${addUrl}"
			class="btn btn-primary btn-sm mb-3" style="background-color:black;"> Add Student </a> 
			<c:url var="logoutUrl" value = "/logout" />
        
		<a href="${logoutUrl}" 
				class="btn btn-primary btn-sm mb-3 mx-auto"  style="background-color:black;">Logout </a> 
